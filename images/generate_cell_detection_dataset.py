...
file_limit = 10000
path = './raw/'
bw_directory = "./black_white/"
train_directory = './cell_obj_detection_images/train/'
valid_directory = './cell_obj_detection_images/valid/'
...
for f in os.listdir(path):
    ...
    # note end up only using d2 images for object detection training as the images seemed to have the cells more defined
