% Based code is an example from from https://www.mathworks.com/help/vision/examples/motion-based-multiple-object-tracking.html
% To run, modify the VIDEO_FILE path to point to a video file.
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        VIDEO_FILE = 'videos/A_01.mp4';        
        obj.reader = vision.VideoFileReader(VIDEO_FILE);
