...
path = './images/raw/NG108Fuccicontrol3,mon1ugmL3,imaging media_Plate_R_p'
output_path = './images/blended/'
for f in ["A01", "A02", "A03", "A04", "A05", "A06"]:
    ...
    for i in range(0, 789):
        ...
        if os.path.exists('%s%s_0_%sf00d0.TIF' % (path, file_nbr, f)) \
           and os.path.exists('%s%s_0_%sf00d2.TIF' % (path, file_nbr, f)):
